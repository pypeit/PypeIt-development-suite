...
_sensfunc = {
    ...
    'keck_hires': {
        ...
        'J0100+2802_H237Hr_RED_C1_ECH_0.88_XD_1.46_1x2': [dict(std_file='spec1d_*20151102.55379*.fits',
                                                          sens_file='keck_hires_RED_C1_ECH_0.88_XD_1.46_1x2_G191-B2B.sens')],
        'J0100+2802_H237Hr_RED_C1_ECH_-0.91_XD_1.46_1x2': [dict(std_file='spec1d_*20151102.54663*.fits',
                                                           sens_file='keck_hires_RED_C1_ECH_-0.91_XD_1.46_1x2_G191-B2B.sens')],
        'J0100+2802_N255Hr_RED_C2_ECH_0.74_XD_1.39_1x3': [dict(std_file='spec1d_*20141015.53363*.fits',
                                                          sens_file='keck_hires_RED_C2_ECH_0.74_XD_1.39_1x3_G191B2B.sens')],
        'J0100+2802_N255Hr_RED_C2_ECH_-0.84_XD_1.29_1x3': [dict(std_file='spec1d_*20141015.19218*.fits',
                                                           sens_file='keck_hires_RED_C2_ECH_-0.84_XD_1.29_1x3_Feige110.sens')],
                     },
    'keck_mosfire': {
